...
public class PrettyPrinter {
  ...
  private String printFactor(Factor f) {
    ...
    if (f instanceof Factor.Var v)
      return hats(v.getNReferences()) + v.getVariable().getName();
  ...
  private static String hats(int n) {
